...
Criado em 07/set/2026, no início do glow-up (redesign completo para compartilhar a plataforma com outros alunos, gratuita e sem login).

## Índice

| Spec | O que cobre | Status |
|---|---|---|
| [01-architecture.md](01-architecture.md) | Stack, arquivos, ordem de carga, rotas, estado local, deploy, restrições | Vigente (estado atual) + alvo do glow-up |
...
- Antes de mexer em `app.js`, `style.css`, `index.html` ou `visualizers.js`: ler 01, 02 e 03.
